...
const USER_CONFIG = {
   ...
   */
  USERS: [otG0j6UIbe6rWst4arh9iyBAqXqM,otG0j6TB0B9HxMYYla5nTUDmDs_4
    {
      // 想要发送的人的名字
      name: '宝贝',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '粉子宝贝', year: '2003', date: '01-20',
        },
        {
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2020-10-9' },
        // 结婚纪念日
        { keyword: 'marry_day', date: '' },
        // 退伍日
        { keyword: 'ex_day', date: '2' }
      ],
      // 课程表相关配置
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '*生日', name: '宝贝', year: '2003', date: '08-07', isShowAge: true,
    },
    {
